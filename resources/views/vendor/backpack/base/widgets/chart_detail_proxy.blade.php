...
<div class="chart-container" style="position: relative; height:40vh; width:80vw">
    <canvas id="chartDetailProxy"></canvas>
</div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card text-white bg-error mb-2">
            <div class="card-body">
                ...
                <div class="progress progress-white progress-xs my-2">
                    <div class="progress-bar progress-log-error" role="progressbar" aria-valuenow="100"
                        aria-valuemin="0" aria-valuemax="100"></div>
                </div>
...
@push('after_scripts')
    <script>
        ...
        function renderChartLogProxyStatus(date_start = null, date_end = null) {
            ...
            const ctx = document.getElementById('chartDetailProxy');
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    const progressSuccess = isNaN((sumSuccessCounts / (sumSuccessCounts + sumErrorCounts)) *
                        100) ? 0 : (sumSuccessCounts / (sumSuccessCounts + sumErrorCounts)) * 100;
                    const progressError = isNaN((sumErrorCounts / (sumSuccessCounts + sumErrorCounts)) * 100) ?
                        0 : (sumErrorCounts / (sumSuccessCounts + sumErrorCounts)) * 100;
